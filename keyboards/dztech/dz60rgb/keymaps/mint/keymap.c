...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        TO(3), _______, KC_UP,   _______, _______, _______, _______, _______, KC_INS,  _______, KC_PSCR, KC_SCRL, _______, _______,
    ...
    [2] = LAYOUT(
        ...
        _______,          _______, _______, _______, _______, NK_TOGG, _______, _______, _______, _______, _______, _______, _______,
